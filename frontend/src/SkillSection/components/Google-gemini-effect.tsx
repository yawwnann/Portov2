...
// SVG untuk 5 logo kiri (JavaScript, Python, Java, C++, Go)
const leftLogos = [
  javascript, // JavaScript
  python, // Python
  laravel, // Laravel (ganti Java)
  cpp, // C++
  // go,      // Go (diganti React)
  react, // React
];

// SVG untuk 5 logo kanan (TypeScript, PHP, Ruby, React, Node.js)
const rightLogos = [
  typescript, // TypeScript
  php, // PHP
  mysql, // MySQL (ganti Ruby)
  mongodb, // MongoDB (ganti HTML)
  nodejs, // Node.js (ganti C#)
];
...
export const GoogleGeminiEffect = ({
  ...
  // Koordinat y ujung kanan untuk setiap path utama
  ...
  return (
    <div className={cn("sticky top-80", className)}>
      ...
      >
        {/* Semua path dan motion.path di sini */}
        {/* Path 1: y kiri 663, y kanan 662.5 */}
        <motion.path
        ...
        />
        {/* Path 2: y kiri 587.5, y kanan 588 */}
        <motion.path
          ...
          transition={transition}
        />
        {/* Path 3: y kiri 514, y kanan 513.235 */}
        <motion.path
          ...
          transition={transition}
        />
        {/* Path 4: y kiri 438.5, y kanan 439 */}
        <motion.path
        ...
        {rightYs.map((y, i) => {
          ...
          const isBig = i >= 2; // index 2, 3, 4
          const size = isBig ? 80 : 56;
          const yOffset = isBig ? y - 40 : y - 28;
          return (
            <g key={`right-${i}`}>
              <image
                x="1400"
